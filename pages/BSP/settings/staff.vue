...
const staffList = ref([
  { id: 1, name: 'Eric Tong', email: 'eric@britishschoolportal.com', role: 'superadmin', status: 'active', lastLogin: '2026-05-04 14:30' },
  { id: 2, name: 'Sarah Chen', email: 'sarah@britishschoolportal.com', role: 'admin', status: 'active', lastLogin: '2026-05-04 11:15' },
  { id: 3, name: 'James Wilson', email: 'james@britishschoolportal.com', role: 'moderator', status: 'active', lastLogin: '2026-05-03 16:45' },
])

const roles = ref([
  { name: 'Super Admin', permissions: ['Full Access', 'Manage Staff', 'Financial Control', 'System Settings'] },
  { name: 'Admin', permissions: ['Manage Users', 'Approve Applications', 'View Payments', 'Edit Content'] },
  { name: 'Moderator', permissions: ['Review Applications', 'View Users', 'Send Notifications'] },
])
...
.role-moderator { background: #d1fae5; color: #047857; }
